...
% Version 06.0 SAH 120119

function paramBrowserWhisk(array, contacts, params, varargin)
if nargin <4
    if nargin==1
    ...
    set(fbutton,'ClickedCallback',['paramBrowserWhisk(' params.arrayname ',' params.contactsname ', params,''next'')'])
    set(bbutton,'ClickedCallback',['paramBrowserWhisk(' params.arrayname ',' params.contactsname ', params,''last'')'])
    set(abutton,'ClickedCallback',['paramBrowserWhisk(' params.arrayname ',' params.contactsname ', params,''add'')'])
    set(dbutton,'ClickedCallback',['paramBrowserWhisk(' params.arrayname ',' params.contactsname ', params,''del'')'])
    set(rbutton,'ClickedCallback',['paramBrowserWhisk(' params.arrayname ',' params.contactsname ', params,''recalc'')'])
    set(sbutton,'ClickedCallback',['paramBrowserWhisk(' params.arrayname ',' params.contactsname ', params,''save'')'])
    
    set(floatToggle,'OnCallback',  ['paramBrowserWhisk(' params.arrayname ',' params.contactsname ', params,''floatOn'')'])
    set(floatToggle,'OffCallback', ['paramBrowserWhisk(' params.arrayname ',' params.contactsname ', params,''floatOff'')'])
    set(zoomToggle,'OnCallback',  ['paramBrowserWhisk(' params.arrayname ',' params.contactsname ', params,''zoomOut'')'])
    set(zoomToggle,'OffCallback', ['paramBrowserWhisk(' params.arrayname ',' params.contactsname ', params,''zoomIn'')'])
    
    
    % Setup menus
    m1=uimenu(hParamBrowserGui,'Label','Time Period','Separator','on');
    uimenu(m1,'Label','All'                          ,'Callback', ['paramBrowserWhisk(' params.arrayname ',' params.contactsname ', params,''all'')']);
    uimenu(m1,'Label','Contacts Only'                ,'Callback', ['paramBrowserWhisk(' params.arrayname ',' params.contactsname ', params,''contactsOnly'')']);
    uimenu(m1,'Label','Exclude Contacts'             ,'Callback', ['paramBrowserWhisk(' params.arrayname ',' params.contactsname ', params,''excludeContacts'')']);
    uimenu(m1,'Label','Pole Presentation to Decision','Callback', ['paramBrowserWhisk(' params.arrayname ',' params.contactsname ', params,''poleToDecision'')']);
    uimenu(m1,'Label','First Contact to Decision'    ,'Callback', ['paramBrowserWhisk(' params.arrayname ',' params.contactsname ', params,''contactToDecision'')']);
    uimenu(m1,'Label','Post Decision'                ,'Callback', ['paramBrowserWhisk(' params.arrayname ',' params.contactsname ', params,''postDecision'')']);
    uimenu(m1,'Label','Post Pole'                    ,'Callback', ['paramBrowserWhisk(' params.arrayname ',' params.contactsname ', params,''postPole'')']);
    uimenu(m1,'Label','Abritrary Range'              ,'Callback', ['paramBrowserWhisk(' params.arrayname ',' params.contactsname ', params,''arbitrary'')']);
    
    m2=uimenu(hParamBrowserGui,'Label','Adjust parameters','Separator','on');
    uimenu(m2,'Label','Plots'   ,'Callback',['paramBrowserWhisk(' params.arrayname ',' params.contactsname ', params,''adjPlots'')']);
    uimenu(m2,'Label','Spikes'  ,'Callback',['paramBrowserWhisk(' params.arrayname ',' params.contactsname ', params,''adjSpikes'')']);
    uimenu(m2,'Label','Contacts','Callback',['paramBrowserWhisk(' params.arrayname ',' params.contactsname ', params,''adjContacts'')']);
    uimenu(m2,'Label','Trial Range','Callback',['paramBrowserWhisk(' params.arrayname ',' params.contactsname ', params,''adjTrials'')']);
    
    uimenu(hParamBrowserGui,'Label','Jump to sweep','Separator','on','Callback',['paramBrowserWhisk(' params.arrayname ',' params.contactsname ', params,''jumpToSweep'')']);
    
    m3=uimenu(hParamBrowserGui,'Label','Summarize','Separator','on');
    uimenu(m3,'Label','STA'     ,'Callback',['paramBrowserWhisk(' params.arrayname ',' params.contactsname ', params,''STA'')']);
    uimenu(m3,'Label','Clusts'  ,'Callback',['paramBrowserWhisk(' params.arrayname ',' params.contactsname ', params,''clusts'')']);
    uimenu(m3,'Label','Tuning'  ,'Callback',['paramBrowserWhisk(' params.arrayname ',' params.contactsname ', params,''tuning'')']);
    uimenu(m3,'Label','Contacts','Callback',['paramBrowserWhisk(' params.arrayname ',' params.contactsname ', params,''contacts'')']);
    uimenu(m3,'Label','Fit'     ,'Callback',['paramBrowserWhisk(' params.arrayname ',' params.contactsname ', params,''fit'')']);
    ...
    for j = 1:length(varargin);
        ...
        switch argString
            ...
            case 'save'
                ...
                save(['Z:\users\Andrew\Whisker Project\SingleUnit\ConTA\ConTA_' array.mouseName '_' array.sessionName], 'contacts', 'params')
...
if isempty(cW)==1
    ...
    text(.1,.1, ['\fontsize{10}' 'Location : ' num2str(array.depth) ' (um)' ' ' num2str(array.recordingLocation)]) ;
    ...
    try
        plot(array.trials{params.sweepNum}.behavTrial.beamBreakTimes,.2e-7,'m*')
    end
