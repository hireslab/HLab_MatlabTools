...
for cAlign = 1:5; % Number of contact to align to
 ...
 for k=1
    ...
    plot(edges+binSize/2,allHist{k},'.-','MarkerSize',10,'Color',colors(cAlign,:),'LineWidth',2)
...
print(gcf, '-depsc', ['Q:\Silicon\Figures\AdaptationExamplePSTH'])
...
print(gcf, '-depsc', ['Q:\Silicon\Figures\AdaptationExampleForces'])
