...
for i = 1:2
    ...
    alignTimes = cellfun(@(x)x.pinDescentOnsetTime,T.trials(trialInds{i}),'UniformOutput',0);
...
for i = 3:10
    ...
    plotHist(spikeTimes,alignTimes,binSize,plotLimits,plotColor{i});
              ...
              print('-depsc', ['Z:\users\Andrew\Whisker Project\SingleUnit\Figures\CueAligned\PoleInAligned_' SU.cellName{cellNum}])   
end
