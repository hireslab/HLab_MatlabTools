...
% v. 2.1
% 11/7/14        Override file header size, setting to 2^13 instead of 2^10 
%                if headerInfo.Version >=5.  Andrew Hires; shires@usc.edu
%                
...
if nargout > 1
   ...
   % headerSize = 
    ...
    while 1
        fseek(fid, headerInfo.HeaderSize + nread * headerInfo.TrueImageSize, 'bof');
