...
contacts{whiskerTIN}.manualDel{tidx} = unique(cat(2,toDel,contacts{whiskerTIN}.manualDel{tidx}));

contacts{whiskerTIN}.contactInds{tidx} = setdiff(contacts{whiskerTIN}.contactInds{tidx},contacts{whiskerTIN}.manualDel{tidx});
contacts{whiskerTIN}.manualAdd{tidx}   = setdiff(contacts{whiskerTIN}.manualAdd{tidx},contacts{whiskerTIN}.manualDel{tidx});
